...
wasmd tx wasm instantiate $CODE_ID '{"count": 0, "recovery_pool": [], "approval_pool": [], "recovery_approvals_needed": 1, "transfer_ownership_approvals_needed": 1}' --from main --chain-id $CHAIN_ID --label 'Test' --no-admin
sleep 5
